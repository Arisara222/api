...
class Login_model extends CI_Model
{
                ...
                if ($query_chk_login->num_rows() > 0) {
                    ...
                    if ($query_chk_status_permis->num_rows() > 0) {
                        ...
                        return array(
                            ...
                            'emp_name' => $query_login_data->sa_firstname,
    ...
    public function get_menu($data){
        ...
        $sql_main_menu = "  SELECT t3.smm_id,t3.smm_name , t3.smm_icon
                            ...
                            INNER JOIN ( 
                                    SELECT t1.smm_id,t1.smm_name ,t2.ssm_id,t1.smm_order ,t1.smm_icon
                            ...
                            GROUP BY t3.smm_name,t3.smm_order,t3.smm_id ,t3.smm_icon
                            ORDER BY t3.smm_order ";
